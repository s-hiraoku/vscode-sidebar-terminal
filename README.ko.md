...
- **완전한 기능** -- 분할 뷰, 세션 지속성, 셸 통합, 터미널 내 검색, 명령 데코레이션, 89개 설정 항목. 장난감이 아닌 프로덕션 터미널입니다.
...
이 확장에는 89개의 설정이 있습니다. 가장 효과적인 커스터마이징 항목:
...
npm test                          # 3,800+ 단위 테스트
npm run test:e2e                  # E2E 테스트(Playwright)
npm run watch                     # 감시 모드
```

품질: TypeScript 엄격 모드, TDD 워크플로, 3,800+ 단위 테스트, Playwright E2E 커버리지, 9개 플랫폼 CI/CD 빌드.
