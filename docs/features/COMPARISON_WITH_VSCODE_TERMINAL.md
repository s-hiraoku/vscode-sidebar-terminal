...
| ------------------------ | ---------------------- | --------------------------- | ------------------------------------------------------- |
| **CLI Agent検出**        | ❌ なし                | ✅ **リアルタイム検出**     | 🟢 Claude Code, Copilot, Gemini, Codex, Antigravity対応 |
...
| **最大ストレージ**       | -                      | **20MB（デフォルト）** | 設定可能：1MB～100MB   |
...
CLI_AGENT_FLUSH_INTERVAL: 4ms  // 250fps
MAX_BUFFER_SIZE: 50行
...
| **CLI Agent出力**               | 16ms/フレーム | 4ms/フレーム       | **4倍高速** |
