...
- **全功能** -- 分屏视图、会话持久化、Shell 集成、终端内搜索、命令装饰器、89 项可配置设置。这不是玩具——而是一个生产级终端。
...
质量：TypeScript 严格模式、TDD 工作流、3,800+ 单元测试、Playwright E2E 覆盖、9 平台 CI/CD 构建。
