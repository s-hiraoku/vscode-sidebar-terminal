...
| Secondary Terminal: Toggle Panel Navigation Mode | `ctrl+p` | `ctrl+p` |
| Secondary Terminal: Exit Panel Navigation Mode | `ctrl+p` | `ctrl+p` |
| Secondary Terminal: Exit Panel Navigation Mode | `escape` | `escape` |
| Secondary Terminal: Focus Previous Terminal | `h` | `h` |
| Secondary Terminal: Focus Next Terminal | `j` | `j` |
| Secondary Terminal: Focus Previous Terminal | `k` | `k` |
| Secondary Terminal: Focus Next Terminal | `l` | `l` |
| Secondary Terminal: Focus Previous Terminal | `left` | `left` |
| Secondary Terminal: Focus Next Terminal | `right` | `right` |
| Secondary Terminal: Focus Previous Terminal | `up` | `up` |
| Secondary Terminal: Focus Next Terminal | `down` | `down` |
| Secondary Terminal: Create New Terminal | `r` | `r` |
| Secondary Terminal: Create New Terminal | `d` | `d` |
| Kill Terminal | `x` | `x` |
