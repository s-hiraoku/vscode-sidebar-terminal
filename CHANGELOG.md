...
- restore sidebar terminal focus reliably when external extensions steal it ([3ab58b5](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/3ab58b5b6f3f852f164be060d62622512f2fa3d5))
...
- remove focus-stealing from file reference commands ([#579](https://github.com/s-hiraoku/vscode-sidebar-terminal/issues/579)) ([32b553d](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/32b553dce1e7eafda1c20ba09b687e8c9198c170))
...
- delay focus restoration to reliably prevent focus stealing ([a625226](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/a6252262e58ca8e841433d1e003f64d7d9911a65)), closes [#576](https://github.com/s-hiraoku/vscode-sidebar-terminal/issues/576)

### [0.4.11](https://github.com/s-hiraoku/vscode-sidebar-terminal/compare/v0.4.10...v0.4.11) (2026-04-07)

### Added

- add focus protection to prevent other extensions from stealing sidebar terminal focus ([ed573af](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/ed573af93cfe0581b186938ead30685fd2eed038)), closes [#576](https://github.com/s-hiraoku/vscode-sidebar-terminal/issues/576)

### [0.4.10](https://github.com/s-hiraoku/vscode-sidebar-terminal/compare/v0.4.9...v0.4.10) (2026-04-04)

### Fixed

- **notifications:** skip native notifications when VS Code is focused ([a5d22c2](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/a5d22c2fe45b98aaa637878c05019c10b111576c))

### Changed

- **notifications:** remove redundant focused check in shouldActivate ([66a60d0](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/66a60d0524c9abaafa71eb6fae70215b01cc3dfe))

### [0.4.9](https://github.com/s-hiraoku/vscode-sidebar-terminal/compare/v0.4.8...v0.4.9) (2026-04-04)

### Fixed

- **notifications:** skip window activation when VS Code is focused ([41789dc](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/41789dc5bf2c677ea4de7934b414a9842bcb708d))
...
- **notifications:** keep waiting active until user input ([55c2a42](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/55c2a426dfe2a0b19300b5f702295218d653ad6b))
...
- **webview:** format theme regression follow-up ([3e9dc32](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/3e9dc323c5e788fdd507020d73eaf11c8a231487))
- **webview:** sync terminal theme background ([125ed90](https://github.com/s-hiraoku/vscode-sidebar-terminal/commit/125ed90e4d01f1957b60a6a0a020fcc6c9c54992))
...
- **Panel Navigation Mode (Zellij-style)**:
  - Added dedicated navigation mode for quick switching between split terminals.
  - Activation with `Ctrl+P` (all platforms). `Cmd+P` on macOS is reserved for VS Code Quick Open.
  - Navigation using `h`, `j`, `k`, `l` or arrow keys.
  - Exit mode with `Escape` or the toggle shortcut.
  - Visual mode indicator in the top-right corner.
  - Integrated with extension-side commands and context keys.
