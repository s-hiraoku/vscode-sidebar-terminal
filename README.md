...
- **Smart Display Modes**: Seamless transitions between normal, fullscreen, and split views with emoji mode indicators (🖥️ fullscreen, ▦ split) - click emoji to toggle (v0.1.111+)
