...
Deine Seitenleiste, dein Terminal, deine KI-Agenten -- alles an einem Ort.
...
Respektiert VS Codes Telemetrie-Einstellungen. Sammelt niemals Terminal-Inhalte oder Dateipfade. Siehe [PRIVACY.md](PRIVACY.md).

## Links

- [Dokumentation](https://s-hiraoku.github.io/vscode-sidebar-terminal/de/)
